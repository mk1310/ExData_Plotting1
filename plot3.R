...
##Plot graph 3
png(file = "D:/csra/IN_PROGRESS/Exploratory Analysis/assign1/plot3.png", width = 480, height = 480, units = "px", pointsize = 12, bg = "transparent",  res = NA)
par(mfrow=c(1,1))
plot(d_feb$Time,d_feb$Sub_metering_1,type="l", xlab="", ylab="Energy sub metering", main="")
